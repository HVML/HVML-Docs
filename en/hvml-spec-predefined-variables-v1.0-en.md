...
- HVML (Hybrid Virtual Markup Language), is a data-driven programmable markup language proposed by [Vincent Wei] (https://github.com/VincentWei). The following parts of the [HVML Specification](hvml-spec-v1.0-zh.md) are relevant to this document:
