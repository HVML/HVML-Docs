...
- [3) HVML 语法](#3-hvml-语法)
   ...
   + [3.2) 解析 HVML 文档](#32-解析-hvml-文档)
      ...
      * [3.2.5) 断词/Tokenization](#325-断词tokenization)
         ...
         - [3.2.5.35) Before attribute value state](#32535-before-attribute-value-state)
         - [3.2.5.36) Attribute value (double-quoted) state](#32536-attribute-value-double_quoted-state)
         - [3.2.5.37) Attribute value (single-quoted) state](#32537-attribute-value-single_quoted-state)
         - [3.2.5.38) Attribute value (unquoted) state](#32538-attribute-value-unquoted-state)
         - [3.2.5.39) After attribute value (quoted) state](#32539-after-attribute-value-quoted-state)
         - [3.2.5.40) Self-closing start tag state](#32540-self_closing-start-tag-state)
         - [3.2.5.41) Bogus comment state](#32541-bogus-comment-state)
         - [3.2.5.42) Markup declaration open state](#32542-markup-declaration-open-state)
         - [3.2.5.43) Comment start state](#32543-comment-start-state)
         - [3.2.5.44) Comment start dash state](#32544-comment-start-dash-state)
         - [3.2.5.45) Comment state](#32545-comment-state)
         - [3.2.5.46) Comment less-than sign state](#32546-comment-less_than-sign-state)
         - [3.2.5.47) Comment less-than sign bang state](#32547-comment-less_than-sign-bang-state)
         - [3.2.5.48) Comment less-than sign bang dash state](#32548-comment-less_than-sign-bang-dash-state)
         - [3.2.5.49) Comment less-than sign bang dash dash state](#32549-comment-less_than-sign-bang-dash-dash-state)
         - [3.2.5.50) Comment end dash state](#32550-comment-end-dash-state)
         - [3.2.5.51) Comment end state](#32551-comment-end-state)
         - [3.2.5.52) Comment end bang state](#32552-comment-end-bang-state)
         - [3.2.5.53) DOCTYPE state](#32553-doctype-state)
         - [3.2.5.54) Before DOCTYPE name state](#32554-before-doctype-name-state)
         - [3.2.5.55) DOCTYPE name state](#32555-doctype-name-state)
         - [3.2.5.56 After DOCTYPE name state](#32556-after-doctype-name-state)
         - [3.2.5.57 After DOCTYPE public keyword state](#32557-after-doctype-public-keyword-state)
         - [3.2.5.58 Before DOCTYPE public identifier state](#32558-before-doctype-public-identifier-state)
         - [3.2.5.59 DOCTYPE public identifier (double-quoted) state](#32559-doctype-public-identifier-double_quoted-state)
         - [3.2.5.60 DOCTYPE public identifier (single-quoted) state](#32560-doctype-public-identifier-single_quoted-state)
         - [3.2.5.61 After DOCTYPE public identifier state](#32561-after-doctype-public-identifier-state)
         - [3.2.5.62 Between DOCTYPE public identifier and system information state](#32562-between-doctype-public-identifier-and-system-information-state)
         - [3.2.5.63 After DOCTYPE system keyword state](#32563-after-doctype-system-keyword-state)
         - [3.2.5.64 Before DOCTYPE system information state](#32564-before-doctype-system-information-state)
         - [3.2.5.65 DOCTYPE system information (double-quoted) state](#32565-doctype-system-information-double_quoted-state)
         - [3.2.5.66 DOCTYPE system information (single-quoted) state](#32566-doctype-system-information-single_quoted-state)
         - [3.2.5.67 After DOCTYPE system information state](#32567-after-doctype-system-information-state)
         - [3.2.5.68 Bogus DOCTYPE state](#32568-bogus-doctype-state)
         - [3.2.5.69 CDATA section state](#32569-cdata-section-state)
         - [3.2.5.70 CDATA section bracket state](#32570-cdata-section-bracket-state)
         - [3.2.5.71 CDATA section end state](#32571-cdata-section-end-state)
         - [3.2.5.72 Character reference state](#32572-character-reference-state)
         - [3.2.5.73 Named character reference state](#32573-named-character-reference-state)
         - [3.2.5.74 Ambiguous ampersand stat](#32574-ambiguous-ampersand-stat)
         - [3.2.5.75 Numeric character reference state](#32575-numeric-character-reference-state)
         - [3.2.5.76 Hexadecimal character reference start state](#32576-hexadecimal-character-reference-start-state)
         - [3.2.5.77 Decimal character reference start state](#32577-decimal-character-reference-start-state)
         - [3.2.5.78 Hexadecimal character reference state](#32578-hexadecimal-character-reference-state)
         - [3.2.5.79 Decimal character reference state](#32579-decimal-character-reference-state)
         - [3.2.5.80 Numeric character reference end state](#32580-numeric-character-reference-end-state)
      * [3.2.6) 树的构造](#326-树的构造)
