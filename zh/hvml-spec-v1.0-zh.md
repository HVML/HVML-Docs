...
- [附录](#附录)
   + [附.1) 修订记录](#附1-修订记录)
      * [OR1) 250630](#or1-250630)
         - [OR1.1) 调整 `change:*` 事件的负载](#or11-调整-change-事件的负载)
         - [OR1.2) 新增 `adapt` 标签](#or12-新增-adapt-标签)
         - [OR1.3) 新增 `AssertionFailed` 异常](#or13-新增-assertionfailed-异常)
         - [OR1.4) 新增运算符表达式](#or14-新增运算符表达式)
      * [OR0) 250428](#or0-250428)
...
为方便执行常见的算术或逻辑运算而引入运算符表达式。HVML 的运算符表达式可出现在任意的 HVML 求值表达式中，亦可包括复合求值表达式。
