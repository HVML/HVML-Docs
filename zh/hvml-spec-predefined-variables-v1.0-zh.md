...
- `Overflow`：对参数进行数值化处理时出现向上溢出错误；静默求值时返回有符号长整数表达范围中的最大值。
- `UnderFlow`：对参数进行数值化处理时出现向下溢出错误；静默求值时返回有符号长整数表达范围中的最小值。
...
- `Overflow`：对参数进行数值化处理时出现向上溢出错误；静默求值时返回无符号长整数表达范围中的最大值。
- `UnderFlow`：对参数进行数值化处理时出现向下溢出错误；静默求值时返回无符号长整数表达范围中的最小值（`0UL`）。
